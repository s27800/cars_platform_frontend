...
import { Button, Spinner, Badge, Tabs } from '../../shared/components/ui';
import { DataProposalModal } from '../dataProposals';
import ImageGallery from './ImageGallery';
import SpecificationSection from './SpecificationSection';
import SimilarCars from './SimilarCars';
import { ReviewsSection } from '../reviews';
import { FuelReportsSection } from '../fuelReports';
import { getCarDisplayName, getStorageItem, setStorageItem } from '../../shared/utils/helpers';
import { STORAGE_KEYS } from '../../shared/utils/constants';
import { MAX_COMPARISON_CARS } from '../comparison';


// Full car page: gallery, specification, reviews and fuel reports
const CarDetailsPage = () => {
  ...
  const carName = getCarDisplayName(car) || tCommon('buttons.loading');
              ...
              <div className="mt-4 p-3 bg-primary-50 dark:bg-primary-900/20 rounded-lg">
                <p className="text-sm text-primary-700 dark:text-primary-300">
                  ...
                  <Link to="/comparison" className="underline hover:no-underline">
                    ...
                    <IoArrowForwardOutline className="inline w-4 h-4 ml-1" />
                  </Link>
                </p>
              </div>
            )}
