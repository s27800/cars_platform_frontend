...
import { getBrands, getBrandById } from '../brands/api';
import { getModelById } from '../brands/modelsApi';
import { getBodyTypes } from './bodyTypesApi';
import { getTags } from '../../shared/api/tags';
import { Select, Input, Button, Checkbox } from '../../shared/components/ui';
...
// Filter sidebar for the car search
const FiltersPanel = ({
  filters,
  onFiltersChange,
  onReset,
