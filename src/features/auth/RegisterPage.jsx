...
// Account creation form - signs the new user in automatically
const RegisterPage = () => {
  ...
  const validationSchema = useMemo(() => Yup.object().shape({
    username: Yup.string()
      ...
      .matches(/^[a-zA-Z0-9_]+$/, t('validation:username.pattern')),
    email: Yup.string()
    ...
    password: Yup.string()
      ...
      .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/, t('validation:password.complexity')),
