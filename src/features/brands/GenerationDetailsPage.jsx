...
import { getGenerationById } from './generationsApi';
import { Button, Spinner, Badge, Pagination, QuickStat } from '../../shared/components/ui';
import { CarCard } from '../cars';
import { getStorageItem, setStorageItem } from '../../shared/utils/helpers';
...
// One generation with the paginated list of its cars
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="max-w-md text-center">
          ...
          <Button to="/" variant="primary">{tCommon('errors.goHome')}</Button>
        </div>
      </div>
    );
  }
