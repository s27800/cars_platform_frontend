...
describe('helpers', () => {
  ...
  describe('formatDate', () => {
    it('should format date string to "DD MMM YYYY" format', () => {
      ...
      expect(formatDate('2024-01-15T10:30:00')).toBe('15 Jan 2024');
    });

    it('should follow the language set on the document', () => {
  ...
  describe('getCarDisplayName', () => {
    ...
    it('should return an empty string if no data available', () => {
      const car = {};
      expect(getCarDisplayName(car)).toBe('');
    });
