...
describe('ToastContainer', () => {
  ...
  describe('dismissal', () => {
    it('should have dismiss button', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByRole('button', { name: 'a11y.dismissNotification' })).toBeInTheDocument();
      });
    });
    ...
    it('should trigger exit animation when close button is clicked', async () => {
      ...
      const dismissButton = screen.getByRole('button', { name: 'a11y.dismissNotification' });
