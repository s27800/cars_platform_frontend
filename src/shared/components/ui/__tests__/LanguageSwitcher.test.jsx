...
describe('LanguageSwitcher', () => {
  ...
  describe('rendering', () => {
    it('should render language switcher button', () => {
      ...
      expect(screen.getByRole('button', { name: 'a11y.changeLanguage' })).toBeInTheDocument();
    });
  ...
  describe('dropdown behavior', () => {
    ...
    it('should show dropdown when button is clicked', () => {
      ...
      fireEvent.click(screen.getByRole('button', { name: 'a11y.changeLanguage' }));
    ...
    it('should have aria-expanded attribute', () => {
      ...
      const button = screen.getByRole('button', { name: 'a11y.changeLanguage' });
    ...
    it('should have aria-haspopup attribute', () => {
      ...
      expect(screen.getByRole('button', { name: 'a11y.changeLanguage' })).toHaveAttribute('aria-haspopup', 'listbox');
    });
  ...
  describe('disabled state', () => {
    it('should be disabled when syncing', () => {
      ...
      expect(screen.getByRole('button', { name: 'a11y.changeLanguage' })).toBeDisabled();
    });
  });
});
