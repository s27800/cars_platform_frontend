...
describe('likes API', () => {
  ...
  describe('Review Likes', () => {
    describe('toggleReviewLike', () => {
      it('should call POST /likes/{reviewId}', async () => {
        const reviewId = 123;
        ...
        expect(apiClient.post).toHaveBeenCalledWith('/likes/123');
    ...
    describe('getReviewLikeStatus', () => {
      it('should call GET /likes/{reviewId}/status', async () => {
        const reviewId = 123;
        ...
        expect(apiClient.get).toHaveBeenCalledWith('/likes/123/status');
