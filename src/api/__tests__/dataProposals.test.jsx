...
import * as dataProposalsApi from '../dataProposals';
...
describe('dataProposals API', () => {
  ...
  describe('resolveProposal', () => {
    it('should call PATCH /data-proposals/resolve/{id} to approve', async () => {
      const proposalId = 1;
    ...
    it('should call PATCH /data-proposals/resolve/{id} to reject with comment', async () => {
      const proposalId = 1;
