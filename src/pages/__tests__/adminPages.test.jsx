...
describe('AdminDashboard', () => {
  ...
  describe('module', () => {
    it('should export AdminDashboard component', async () => {
...
describe('AdminProposalsPage', () => {
  ...
  describe('module', () => {
    it('should export AdminProposalsPage component', async () => {
      const module = await import('../AdminProposalsPage');
...
describe('AdminReviewsPage', () => {
  ...
  describe('module', () => {
    it('should export AdminReviewsPage component', async () => {
      const module = await import('../AdminReviewsPage');
...
describe('AdminFuelReportsPage', () => {
  ...
  describe('module', () => {
    it('should export AdminFuelReportsPage component', async () => {
      const module = await import('../AdminFuelReportsPage');
