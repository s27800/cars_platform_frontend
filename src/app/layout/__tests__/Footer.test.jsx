...
describe('Footer', () => {
  ...
  describe('social links', () => {
    ...
    it('should render social media links', () => {
      ...
      const socialLinks = screen.getAllByRole('link', { name: 'a11y.visitUsOn' });
      const targets = socialLinks.map(link => link.getAttribute('href'));
    ...
    it('should have external links open in new tab', () => {
      ...
      screen.getAllByRole('link', { name: 'a11y.visitUsOn' }).forEach(link => {
